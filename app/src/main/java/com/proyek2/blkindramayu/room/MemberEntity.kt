...
data class MemberEntity(
    @NotNull @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "kd_pengguna") var kd_pengguna: Int,
    @NotNull @ColumnInfo(name = "nomor_ktp") var nomor_ktp : Int,
    @NotNull @ColumnInfo(name = "nama_lengkap") var nama_lengkap : String,
    @NotNull @ColumnInfo(name = "tempat_lahir") var tempat_lahir : Int,
    ...
    @NotNull @ColumnInfo(name = "provinsi") var provinsi : Int,
    @NotNull @ColumnInfo(name = "kabupaten_kota") var kabupaten_kota : Int,
